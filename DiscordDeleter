...
#undiscord.container,
#undiscord .container { background-color: #0A0A0A; border-radius: 8px; box-sizing: border-box; cursor: default; flex-direction: column; }
#undiscord .header { background-color: black; height: 48px; align-items: center; min-height: 48px; padding: 0 16px; display: flex; color: var(--header-secondary); cursor: grab; }
...
#undiscord .danger { background-color: #EE3636; }
...
#undicord-btn.running { color: #EE3636 !important; }
#undicord-btn.running progress { display: block; }
/**** Undiscord Interface ****/
#undiscord { position: fixed; z-index: 100; top: 58px; right: 10px; display: flex; flex-direction: column; width: 800px; height: 80vh; min-width: 610px; max-width: 100vw; min-height: 448px; max-height: 100vh; color: var(--text-normal); border-radius: 4px; background-color: #0A0A0A; box-shadow: var(--elevation-stroke), var(--elevation-high); will-change: top, left, width, height; }
#undiscord .header .icon { cursor: pointer; }
#undiscord .window-body { height: calc(100% - 48px); }
#undiscord .sidebar { overflow: hidden scroll; overflow-y: auto; width: 270px; min-width: 250px; height: 100%; max-height: 100%; padding: 8px; background: #0A0A0A; }
...
#undiscord .tbar { padding: 8px; background-color: #101010; }
...
var undiscordTemplate = (`
    ...
    <div class="header">
        ...
        <h3>Discord Message Deleter</h3>
        <div class="vert-divider"></div>
        <span>Made by: r.u.g</span>
        ...
        <div class="sidebar scroll">
            <details open>
                ...
                <fieldset>
                    <legend>
                        Author ID
                        <a href="{{WIKI}}/authorId" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
                ...
                <fieldset>
                    <legend>
                        Server ID
                        <a href="{{WIKI}}/guildId" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
                    <div class="multiInput">
                        <div class="input-wrapper">
                ...
                <fieldset>
                    <legend>
                        Channel ID
                        <a href="{{WIKI}}/channelId" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
            ...
            <details>
                ...
                <fieldset>
                    <legend>
                        Search
                        <a href="{{WIKI}}/filters" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
                    <div class="input-wrapper">
            ...
            <details>
                ...
                <fieldset>
                    <legend>
                        Search delay
                        <a href="{{WIKI}}/delay" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
                    <div class="input-wrapper">
                ...
                <fieldset>
                    <legend>
                        Discord Token
                        <a href="{{WIKI}}/authToken" title="" target="_blank" rel="noopener noreferrer"></a>
                    </legend>
                    <div class="multiInput">
                        <div class="input-wrapper">
        ...
        <div class="main col">
            <div class="tbar col">
                <div class="row">
                    ...
                    <button id="start" class="sizeMedium danger" style="width: 150px;" title="Start the deletion process">Delete Messages</button>
                    <button id="stop" class="sizeMedium" title="Stop the deletion process" disabled>Stop Deleting</button>
                    <button id="clear" class="sizeMedium">Clear log</button>
                    <label class="row" title="Hide sensitive information">
                        <input id="redact" type="checkbox" checked> Hide sensitive information
                    </label>
					<hr>
                </div>
                <div class="row">
            ...
            <pre id="logArea" class="logarea scroll" style="background-color:#131212">
            </pre>
...
`;
	...
	function fillToken() {
	  try {
	    ...
	    log.info('Please make sure discord is up to date');
	    log.debug('Try rentering a Token.');
	  }
	  return '';
	}
